...
if __name__ == '__main__':
    ...
    print(calc_preco_final(preco_bruto, imposto_x, True))
    print(calc_preco_final(preco_bruto, imposto_x, False))

    print(calc_preco_final(preco_bruto, imposto_y, True, 1.5))
    print(calc_preco_final(preco_bruto, imposto_y, False))
